    ...
    def tick(self):
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if self.stand_rect.collidepoint(pos) and flag < 1 and self.line == 'turn2':
...
#                        flag += 1
                ...
                if self.hit_rect.collidepoint(pos) and player_amount < 21 and flag < 1 and self.line == 'turn2':
                    new_card = Take().card()
